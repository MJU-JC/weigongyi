...
<div class="container">
	<ul class="breadcrumb">
  		...
  		<li><a href="<%=basePath %>ActivityInfo/frontlist">公益活动信息</a></li>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">活动主题:</div>
	...
	<div class="row bottom15"> 
		<div class="col-md-2 col-xs-4 text-right bold">活动时间:</div>
